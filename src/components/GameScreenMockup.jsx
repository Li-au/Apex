  ...
  return (
    <div className="w-full h-screen overflow-hidden bg-gradient-to-br from-[#0c0717] via-[#150b2e] to-[#0a0612] text-white flex flex-col select-none">
      ...
      <div className="relative flex-1 overflow-hidden">
        ...
        {/* Glow (background) - centered on the titan */}
        <div className="absolute left-1/2 top-[calc(60%_-_155px)] -translate-x-1/2 -translate-y-1/2 w-[420px] h-[420px] max-w-[80vw] rounded-full bg-purple-600/30 blur-3xl animate-glow-pulse pointer-events-none z-0" />

        {/* Orbital ring (background) - centered on the titan */}
        <div className="absolute left-1/2 top-[calc(60%_-_155px)] -translate-x-1/2 -translate-y-1/2 w-[460px] h-[460px] max-w-[82vw] max-h-[82vw] rounded-full border border-purple-400/15 animate-spin-slow pointer-events-none z-0">
